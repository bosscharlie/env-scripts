NOOP_HOME=~/Workspace/XiangShan-dev5
spec_dir=spec-gcc12-banck-conflict
...
python3 xs_autorun_multiServer.py $cpt_path2 $json_path2 --xs $NOOP_HOME --threads 16 --dir $spec_dir -L "open11 open12 open15 open24 open26 open27"